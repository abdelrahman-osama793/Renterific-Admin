...
export class DashboardComponent implements OnInit {
  ...
  constructor(
    ...
    private renting: RentingService
  ) {}
  ...
  ////////////////////////////////
  async countUser() {
    await this.myUser.getAllUser().subscribe(
      (res: any) => {
  ...
  async countProduct() {
    await this.myProduct.AllProduct().subscribe(
      (res: any) => {
  ...
  async pendingProd() {
    ...
    await this.myProduct.AllProduct().subscribe(
      (res: any) => {
        ...
        this.pendingCount = products.length;
      },
      (err) => {
        console.log(err);
      }
  ...
  async AcceptedProd() {
    ...
    await this.myProduct.AllProduct().subscribe(
      (res: any) => {
        ...
        this.approvedCount = products.length;
      },
      (err) => {
        console.log(err);
      }
